...
/** @namespace SonbolPwa/Component/NavigationAbstract/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    device: state.ConfigReducer.device
});

/** @namespace SonbolPwa/Component/NavigationAbstract/Container/mapDispatchToProps */
export const mapDispatchToProps = () => ({});

/** @namespace SonbolPwa/Component/NavigationAbstract/Container */

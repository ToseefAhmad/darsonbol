...
import { HOVER_TIMEOUT } from '../../../node_modules/@scandipwa/scandipwa/src/component/MenuItem/MenuItem.config';
import MenuItem from './MenuItem.component';

/** @namespace SonbolPwa/Component/MenuItem/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    device: state.ConfigReducer.device
});

/** @namespace SonbolPwa/Component/MenuItem/Container/mapDispatchToProps */
export const mapDispatchToProps = () => ({});

/** @namespace SonbolPwa/Component/MenuItem/Container */

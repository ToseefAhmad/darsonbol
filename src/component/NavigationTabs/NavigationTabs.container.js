...
/** @namespace SonbolPwa/Component/NavigationTabs/Container/mapStateToProps */
...
/** @namespace SonbolPwa/Component/NavigationTabs/Container/mapDispatchToProps */
...
/** @namespace SonbolPwa/Component/NavigationTabs/Container */
export class NavigationTabsContainer extends NavigationAbstractContainer {
    ...
    handleNavVisibilityOnScroll(windowY) {
        ...
        if (windowY < TOP_MIN_OFFSET) {
            ...
            document.documentElement.classList.remove('headerscroll-fixed');
            return;
        }
        ...
        if (windowY < this.scrollPosition) {
            ...
            document.documentElement.classList.add('headerscroll-fixed');
        }
    }
    ...
    onWishListButtonClick() {
        ...
        if (pathname !== appendWithStoreCode('/wishlist')) {
            scrollToTop();
            isSignedIn() ? browserHistory.push(appendWithStoreCode('/wishlist'))
                : browserHistory.push(appendWithStoreCode('/customer/account/login'));
        }
    }

    onMyAccountButtonClick() {
        const { pathname } = location;
        // const url = appendWithStoreCode(isSignedIn() ? `${ ACCOUNT_URL }` : '/account-page');
        const url = appendWithStoreCode(isSignedIn() ? '/account-page' : '/account-page');

...
import {
    ...
    MENU, PDP,
    SEARCH
} from '../../../node_modules/@scandipwa/scandipwa/src/component/Header/Header.config';
import Header from './Header.component';

/** @namespace SonbolPwa/Component/Header/Container/mapStateToProps */
...
/** @namespace SonbolPwa/Component/Header/Container/mapDispatchToProps */
...
/** @namespace SonbolPwa/Component/Header/Container */
export class HeaderContainer extends NavigationAbstractContainer {
    ...
    containerFunctions = {
        ...
        setToggleToFalse: this.setToggleToFalse.bind(this),
        setIsActiveForClass: this.setIsActiveForClass.bind(this),
        setIsActiveClassToFalse: this.setIsActiveClassToFalse.bind(this),
    ...
    __construct(props) {
        ...
        this.state = {
            ...
            isHovered: false,
            isActiveForClass: false,
            showModal: false
        };
        this.handleToggle = this.handleToggle.bind(this);
        this.mouseEnterHandler = this.mouseEnterHandler.bind(this);
        this.mouseLeaveHandler = this.mouseLeaveHandler.bind(this);
        this.setToggleToFalse = this.setToggleToFalse.bind(this);
        this.setIsActiveForClass = this.setIsActiveForClass.bind(this);
        this.setIsActiveClassToFalse = this.setIsActiveClassToFalse.bind(this);
    ...
    setIsActiveClassToFalse() {
        ...
        this.setState({
            isActiveForClass: boolValue
        });
    }
    setIsActiveForClass() {
        this.setState({
            isActiveForClass: !this.state.isActiveForClass
        });
    }
    ...
    setToggleToFalse() {
        const negativeFlag = false;
        this.setState({
            isHovered: negativeFlag
        });
    }

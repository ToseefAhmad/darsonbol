...
/** @namespace SonbolPwa/Component/ProductLinks/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    linkedProducts: state.LinkedProductsReducer.linkedProducts
});

/** @namespace SonbolPwa/Component/ProductLinks/Container/mapDispatchToProps */
export const mapDispatchToProps = () => ({});

/** @namespace SonbolPwa/Component/ProductLinks/Container */

...
/** @namespace SonbolPwa/Component/ProductCard/Container/mapStateToProps */
...
/** @namespace SonbolPwa/Component/ProductCard/Container/mapDispatchToProps */
export const mapDispatchToProps = (dispatch) => ({
    ...sourceMapDispatchToProps(dispatch),
    showNotification: (type, message) => dispatch(showNotification(type, message))
});

/** @namespace SonbolPwa/Component/ProductCard/Container */

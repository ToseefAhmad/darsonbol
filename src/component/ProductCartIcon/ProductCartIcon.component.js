...
/** @namespace SonbolPwa/Component/ProductCartIcon/Component */
export class ProductCartIconComponent extends PureComponent {
    render() {
        return (
            <svg
...
export default ProductCartIconComponent;

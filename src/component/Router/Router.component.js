...
import {
    ADDRESS_BOOK, MY_DOWNLOADABLE, MY_ORDERS, MY_WISHLIST, NEWSLETTER_SUBSCRIPTION, ORDER_RETURNS
...
export const MyAccountReturns = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "account" */ '../MyAccountReturns/MyAccountReturns.component'));
...
export const LoginAccountPage = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "compare" */ 'Component/MyAccountSignIn'));
...
export const AccountPage = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "header" */ '../MobileAccountLogin/MobileAccountLogin.component'));
export const MobileNavigation = lazy(() => import(/* webpackMode: "lazy", webpackChunkName: "header" */ '../MobileNavigation/index'));

/** @namespace SonbolPwa/Component/Router/Component/withStoreRegex */
export const withStoreRegex = (path) => window.storeRegexText.concat(path);

/** @namespace SonbolPwa/Component/Router/Component */
export class RouterComponent extends PureComponent {
    ...
    [SWITCH_ITEMS_TYPE] = [
        ...
        {
            component: <Route path={ withStoreRegex('/mobile/navigation') } render={ (props) => <MobileNavigation { ...props } /> } />,
            position: 26,
            name: SEARCH
        },
        {
        ...
        {
            component: <Route path={ withStoreRegex('/customer/account/returns') } render={ (props) => <MyAccountReturns { ...props } selectedTab={ ORDER_RETURNS } /> } />,
            position: 77,
            name: MY_ACCOUNT_RETURNS
        },
        {
        ...
        {
            component: <Route path={ withStoreRegex('/account-page') } render={ (props) => <AccountPage { ...props } /> } />,
            position: 85,
            name: ACCOUNT_PAGE
        },
        {

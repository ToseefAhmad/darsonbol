...
/** @namespace SonbolPwa/Route/LoginAccount/Container/mapDispatchToProps */
export const mapDispatchToProps = (dispatch) => ({
    ...sourceMapDispatchToProps(dispatch),
    toggleBreadcrumbs: (isVisible) => dispatch(toggleBreadcrumbs(isVisible))
});

/** @namespace SonbolPwa/Route/LoginAccount/Container */
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(LoginAccountContainer));

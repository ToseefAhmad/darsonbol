...
/** @namespace SonbolPwa/Route/MyAccount/Container/mapStateToProps */
...
/** @namespace SonbolPwa/Route/MyAccount/Container/mapDispatchToProps */
...
/** @namespace SonbolPwa/Route/MyAccount/Container */
export class MyAccountContainer extends PureComponent {
    ...
    containerProps() {
        const { location, match, isMobile } = this.props;

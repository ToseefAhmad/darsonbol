...
/** @namespace SonbolPwa/Route/ProductPage/Container/mapStateToProps */
...
/** @namespace SonbolPwa/Route/ProductPage/Container/mapDispatchToProps */
export const mapDispatchToProps = (dispatch) => ({
    setNavigationState: (stateName) => dispatch(changeNavigationState(BOTTOM_NAVIGATION_TYPE, stateName)),
    changeHeaderState: (state) => dispatch(changeNavigationState(BOTTOM_NAVIGATION_TYPE, state)),
...
/** @namespace SonbolPwa/Route/ProductPage/Container */
export class ProductPageContainer extends PureComponent {
    ...
    containerProps() {
        const {
            isMobile, location, navigationState, totals,
            totals: {
                items = []
            } = {}
        } = this.props;

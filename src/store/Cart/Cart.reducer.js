...
/** @namespace SonbolPwa/Store/Cart/Reducer/updateCartTotals */
...
/** @namespace SonbolPwa/Store/Cart/Reducer/updateShippingPrice */
...
/** @namespace SonbolPwa/Store/Cart/Reducer/getInitialState */
export const getInitialState = () => ({
    cartTotals: BrowserDatabase.getItem(CART_TOTALS) || {}
});

/** @namespace SonbolPwa/Store/Cart/Reducer/CartReducer */

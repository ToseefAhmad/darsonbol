...
/** @namespace Scandiweb/MageplazaProductLabel/Util/ProductLabels/processCss */
...
/** @namespace Scandiweb/MageplazaProductLabel/Util/ProductLabels/processLabel */
export const processLabel = (labelData, pWidth, pHeight, product, isProductPage) => {
    const {
        rule_id,
        same,
        label,
